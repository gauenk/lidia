...
class TestNn1(unittest.TestCase):
    ...
    def test_nonlocal1(self):
        ...
        # -- no-train --
        self.compare_nn1(name,sigma,False,device)
        self.compare_nn1(name,sigma,True,device)

    def compare_nn1(self,name,sigma,train,device):
        ...
        # -- exec nl search  --
        nl_output = model_nl.run_nn1(noisy/255.,train=train)
